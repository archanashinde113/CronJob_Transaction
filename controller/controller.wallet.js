...
// const task = cron.schedule('*/50 * * * * *', function() {
//   bnbTransaction().then(console.log('success send transaction'));
//   // console.log('hello');
// });
...
exports.bnbTransaction = function(req,res){
  ...
  const task = cron.schedule('*/30 * * * *', function() { 
    ...
    res.send('Transaction Successful on Every Half Hour');
    }
